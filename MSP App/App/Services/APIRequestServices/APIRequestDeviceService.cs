...
{
    public class APIRequestDeviceService : BaseAPIRequestService, IAPIRequestDeviceService
    {
        public APIRequestDeviceService(IConfiguration config, HttpClient httpClient, IHttpContextAccessor httpContextAccessor) : base(config, httpClient, httpContextAccessor)
        {
