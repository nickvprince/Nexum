...
{
    public class APIRequestInstallationKeyService : BaseAPIRequestService, IAPIRequestInstallationKeyService
    {
        public APIRequestInstallationKeyService(IConfiguration config, HttpClient httpClient, IHttpContextAccessor httpContextAccessor) : base(config, httpClient, httpContextAccessor)
        {
